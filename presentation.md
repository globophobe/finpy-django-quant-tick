...
# To resolve those challenges, I developed <a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">Django Quant Candles</a>.

課題を解決するために、<a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">Django Quant Candles</a>を開発しました。

---

# <a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a> downloads and aggregates candlesticks from tick data.

<a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a>は取引所のデータをダウンロード集約してローソク足を作成されます。
...
# Regardless of `min_volume`, <br /><a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a> also aggregates the final data point of each minute, so that 1 minute time based candlesticks can also be derived.

`min_volume`は関係なく、<br /><a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a>が各分の最終データポイントも集約するため、1分の時間ベースのローソク足も導出できます。
...
---
layout: code
text: django-quant-candles assumes&#58;
trans: 基本仮定：
...
# One caveat, as described in the [notes](https://github.com/globophobe/django-quant-candles/blob/main/NOTES.md), data quality is a priority. More so than storage costs.

ストレージについて、[書いてあります](https://github.com/globophobe/django-quant-candles/blob/main/NOTES.md)けど、ストレージコストよりもデータ品質が優先です。

---

# The minimum time interval that <a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a> collects data is 1 minute.

<a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a>はデータ収集の最低限の時間間隔は1分です。
...
# Whenever possible, <a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a> partitions data at 1 hour intervals.

出来るだけ、 <a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a>は1時間毎にデータを保存します。
...
# <a style="text-decoration: none;" href="https://github.com/globophobe/django-quant-candles">django-quant-candles</a> is intended for serverless deployment. The demo deploys to GCP Cloud Run, with GCP Cloud Scheduler for periodic execution.
...
# So, I created django-quant-candles.

なんので、django-quant-candles<br />の開発を始まりました。
